                    ...
                    <div class="p-4 text-black  d-flex justify-content-center" style="background-color: #f8f9fa;">
                        ...
                        <div class="row container  ">
                                ...
                                <div class="col-md-12 col-lg-3 pb-lg-0 pb-4  pt-3">
                                    <h2 class="text-md-center text-lg-start text-center  ps-4 "> Ali  maktoB</h2>
                                </div>

                                <div class="col-md-12 col-lg-3 pb-lg-0 pb-4 pt-3">
                                    <h2 class="text-md-center text-lg-start text-center "> 0634537682</h2>
                                </div>
                ...
                <div class="card-body p-4 text-black">
                    <div class="mb-5">
                        ...
                        <div class="p-4" style="background-color: #f8f9fa;">
                            ...
                            <p class="font-italic mb-1">Lives in casblanca</p>
                            <p class="font-italic mb-0">fix car and moto</p>
                        </div>
                    </div>
